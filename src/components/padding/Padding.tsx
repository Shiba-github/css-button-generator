...
export const Padding = () => {
    ...
    return (
        <Flex flexDirection={'column'} alignItems={'center'} margin={'1rem'} padding={'1rem'} width={'100%'} border={'1px'} borderRadius={'1rem'} borderColor={'gray.200'}>
            <Text color={'black'} marginBottom={'1rem'}>Padding</Text>
            <Slider
            id='slider'
            defaultValue={25}
            min={0}
