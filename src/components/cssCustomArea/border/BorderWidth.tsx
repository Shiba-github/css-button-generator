...
import { setDisplayBorderWidth } from '../cssCustomAreaSlice'
    ...
    return (
        <Flex flexDirection={'column'} justifyContent={'space-around'} width={width}>
            <Flex
                ...
                color={color}
                backgroundColor={displayBorderWidth ? onclickBackgroundColor : backgroundColor}
                width={width}
                height={height}
                padding={padding}
                cursor={'pointer'}
            ...
            >
                ...
                <Text fontSize={fontSize}>BorderWidth</Text>
            </Flex>
        </Flex>
    )
}
