...
import { setDisplayPadding } from '../cssCustomAreaSlice'
    ...
    return (
        <Flex flexDirection={'column'} justifyContent={'space-around'} width={width}>
            <Flex
                ...
                color={color}
                backgroundColor={displayPadding ? onclickBackgroundColor : backgroundColor}
                width={width}
                height={height}
                padding={padding}
                cursor={'pointer'}
            ...
            >
                ...
                <Text fontSize={fontSize}>Padding</Text>
            </Flex>
        </Flex>
    )
}
